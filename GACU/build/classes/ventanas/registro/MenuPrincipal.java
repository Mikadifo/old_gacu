...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(760, 70, 50, 23);

        jButton3.setFont(new java.awt.Font("Arial Black", 0, 15)); // NOI18N
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes_Iglesias/igle.png"))); // NOI18N
        getContentPane().add(jButton3);
        jButton3.setBounds(400, 70, 340, 200);
        ...
        jButton6.setBounds(770, 570, 35, 30);
        ...
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes_Institutos/Principal Intituto.png"))); // NOI18N
        getContentPane().add(jButton7);
        jButton7.setBounds(400, 290, 340, 200);

        jButton8.setFont(new java.awt.Font("Arial Black", 0, 15)); // NOI18N
        jButton8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes_Parques/ParquePrincipal1.png"))); // NOI18N
        getContentPane().add(jButton8);
        jButton8.setBounds(40, 70, 340, 200);

        jButton9.setFont(new java.awt.Font("Arial Black", 0, 15)); // NOI18N
        jButton9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes_Museo/MuseoP.png"))); // NOI18N
        getContentPane().add(jButton9);
        jButton9.setBounds(40, 290, 340, 200);
