 ...
 * @author Steve
 */
public class Informacion_PMadre extends javax.swing.JFrame {

    /**
     * Creates new form Madre
     */
    public Informacion_PMadre() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes_Parques/ParquedelMadre.png"))); // NOI18N
        jPanel1.add(jLabel1);
        jLabel1.setBounds(110, 20, 570, 220);

        jTextPane1.setBackground(new java.awt.Color(153, 153, 0));
        jTextPane1.setFont(new java.awt.Font("Arial Black", 0, 12)); // NOI18N
        jTextPane1.setText("Es un parque destinado a la recreación y al deporte, cuenta con espacios verdes y juegos infantiles, así como de un sendero para atletas. Dentro del parque se encuentra las instalaciones de la Escuela de Marcha, deporte de atletismo que es muy común entre los jóvenes cuencanos siguiendo así los pasos del campeón olímpico y múltiple campeón mundial de Marcha Jefferson Pérez, al cual se lo ha honrado con una estatua dentro del propio parque. También se puede acceder al planetario municipal en donde se puede disfrutar de documentales a cerca de la tierra y el espacio de gran interés especialmente para los niños. Dirección: ubicado a las riveras del Tomebamba en la Av. Federico Malo y 12 de abril. ");
        jScrollPane1.setViewportView(jTextPane1);

        jPanel1.add(jScrollPane1);
        jScrollPane1.setBounds(60, 260, 680, 120);
