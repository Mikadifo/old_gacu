...
public class Informacion_MSRuinas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes_Museo/MuseoRuinas.png"))); // NOI18N
        jPanel1.add(jLabel1);
        jLabel1.setBounds(120, 20, 560, 230);

        jTextPane1.setBackground(new java.awt.Color(204, 255, 255));
        jTextPane1.setFont(new java.awt.Font("Arial Black", 0, 12)); // NOI18N
        jTextPane1.setText("Las Ruinas de Todos los Santos, constituye un sitio arqueológico. Aquí podemos encontrar vestigios que fueron descubiertos durante los trabajos de excavación, para construir la casa del Señor Fernando Estrella. Entre los objetos hallados se pudo identificar que los restos pertenecían a las culturas: Cañaris, Incásicos e Hispánica. Fue descubierta en noviembre de 1972, al realizar excavaciones para la construcción de una casa del propietario Fernando Estrella. En 1973 se dio a conocer el informe de la Comisión sobre las Ruinas de Todos Santos el que se refería a la parte baja del Sitio. En 1975 se descubrió nuevos elementos arqueológicos. Durante las excavaciones arqueológicas que se iniciaron a partir de 1972, se rescataron alrededor de veinte mil fragmentos y piezas enteras de cerámica, piedra y letal, que se exhiben en el Museo de Sitios Manuel Agustín Landívar. Dirección: El espacio arqueológico de Todos Santos, está localizado en el margen izquierdo del Río Tomebamba, a 100 metros del puente de Todos Santos. ");
        jScrollPane1.setViewportView(jTextPane1);

        jPanel1.add(jScrollPane1);
        jScrollPane1.setBounds(63, 259, 680, 148);
        ...
        btnVolver.setBounds(345, 425, 100, 40);
